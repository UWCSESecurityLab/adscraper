...
const pageToHandleToDOMMutatorUrls = new Map<puppeteer.Page, Map<puppeteer.ElementHandle, Set<string>>>();
...
export async function trackDOMUpdate(
  ...
  try {
    ...
    if (!handleToURLs) {
      handleToURLs = new Map<puppeteer.ElementHandle, Set<string>>();
